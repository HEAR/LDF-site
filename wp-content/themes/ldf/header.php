...
<body <?php body_class(); ?>>
	...
	<div class="right-box clr fs13 clr-bc cgb">
		<div class="container">
			<?php get_search_form(); ?>
			<a class="up fr lang" href="<?php echo esc_url( home_url( '/?lang=fr' ) ); ?>">fr</a><a class="up en lang" href="<?php echo esc_url( home_url( '/?lang=en' ) ); ?>">en</a><a class="up de lang" href="<?php echo esc_url( home_url( '/?lang=de' ) ); ?>">de</a> <span class="lang_select"></span><a href="https://twitter.com/LDF_1914_2018" class="fa fa-twitter twitter"></a> <a href="https://www.facebook.com/lignesdefront.1914.2018" class="fa fa-facebook facebook"></a>
